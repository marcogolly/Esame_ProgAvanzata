    ...
    {   
        ...
        for (int i=0; i<rows-1; ++i) {
            ...
            for (int j = i + 1; j < rows; j++) {
                // nel caso delle matrici intere moltiplico la riga j per il pivot in modo tale da poter
                // sottrarre alla riga j un multiplo della riga i garantendo di usare solo numeri interi
