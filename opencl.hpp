...
public:
     ...
     * @param rows è il numero di righe della matrice
     * @param cols è il numero di colonne della matrice
     * @param rank è il rango della matrice
     */
    void rank(float* A, const unsigned int rows, const unsigned int cols, int* rank)
    {
        // preparo i buffer
     ...
     * @param A la matrice di partenza
     * @param rows è il numero di righe della matrice 
     * @param cols è il numero di righe della matrice 
     * @param determinant è il determinante della matrice 
     */
    void determinant(float* A, const unsigned int rows, 
     ...
     * @param A_rows è il numero di righe della matrice A
     * @param A_cols è il numero di colonne della matrice A
     * @param B_cols è il numero di colonne della matrice B
     */
     ...
     * 
     * @param A è la matrice
     * @param inv è il vettore risultato
     * @param N è il numero di righe/colonne della matrice
     */
