                                   ...
                                   std::vector<T> &b, const unsigned int repetitions = 4) 
{
    ...
    std::vector<std::string> nomi_metodi = {"getRank", "getDeterminant", "mult_matrix", "mult_vect", "system", "inverse"};

    // array dei metodi sotto forma di oggetti callable (richiamabili) per poi richiamare in modo più pulito i metodi
